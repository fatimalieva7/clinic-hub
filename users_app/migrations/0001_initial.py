...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['email', 'code'], name='users_app_s_email_8f668a_idx')],
            },
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('username', models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name='Никнейм')),
            ...
            options={
                'indexes': [models.Index(fields=['email'], name='users_app_u_email_e1fc0c_idx')],
            },
        ),
    ]
